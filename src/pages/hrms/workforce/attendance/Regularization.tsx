...
export default function Regularization() {
  ...
  const { data, loading, refresh } = useRegularizations({ search: searchTerm });
  ...
  const columns = useMemo(() => [
    ...
    { key: 'outTime', label: 'Out Time', sortable: true },
    ...
    <div className="flex flex-col h-full bg-white dark:bg-[#181a1f] p-4 lg:p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Review employee attendance regularizations</p>
        </div>
        <button 
