...
export default function PayrollDashboard() {
 ...
 { title: 'Final Settlements', value: '3 Pending', icon: FileText, color: 'text-primary', bgColor: 'bg-primary/10' },
 ];
 ...
 <button onClick={() => navigate('/companydashboard/hrms/payroll/list')} className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-md hover:bg-[#5d1944] transition-colors text-sm font-medium shadow-sm">
 <Plus size={16} />
 New Payroll Run
 </button>
 </div>
 ...
 <button key={i} onClick={() => navigate('/companydashboard/hrms/payroll/list')} className="flex flex-col items-center justify-center gap-3 p-4 rounded-md border border-gray-200 dark:border-gray-800 hover:border-primary/30 hover:bg-primary/5 transition-all group">
 ...
 <button onClick={() => navigate('/companydashboard/hrms/payroll/list')} className="text-primary dark:text-secondary hover:underline font-medium text-xs bg-primary/5 px-3 py-1.5 rounded-md">View Details</button>
 </td>
 </tr>
 <tr className="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors group">
