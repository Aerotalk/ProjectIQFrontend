...
export default function PayrollDashboard() {
 ...
 <button onClick={() => navigate(`${basePath}/hrms/payroll/list`)} className="flex items-center gap-2 px-4 py-2 bg-primary text-white rounded-md hover:bg-[#5d1944] transition-colors text-sm font-medium shadow-sm">
 <Plus size={16} />
 New Payroll Run
 </button>
 </div>
 ...
 <button key={i} onClick={() => navigate(`${basePath}/hrms/payroll/list`)} className="flex flex-col items-center justify-center gap-3 p-4 rounded-md border border-gray-200 dark:border-gray-800 hover:border-primary/30 hover:bg-primary/5 transition-all group">
