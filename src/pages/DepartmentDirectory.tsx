...
export default function DepartmentDirectory() {
 ...
 <div key={dept.id} className="bg-white dark:bg-[#181a1f] p-5 rounded-lg border border-gray-200 dark:border-gray-800 shadow-sm hover:shadow-md hover:border-primary/30 transition-all group relative flex flex-col">
 ...
 className="w-full px-3 py-2 text-sm bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-md focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all dark:text-white"
 ...
 className="w-full px-3 py-2 text-sm bg-white dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-md focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-all dark:text-white resize-none"
