...
export default function VendorIdentitySection({ readOnly }: Props) {
  ...
  return (
    <FormSection title="Step 2 — Vendor Identity">
      <FormGrid>
        <FormRow>
          <label className={formStyles.label}>Vendor Type *</label>
          <div className="flex gap-4 mt-2">
            <label htmlFor="vendor-type-business" className="flex items-center gap-2">
              <input id="vendor-type-business" type="radio" value="Business" {...register('vendorType')} disabled={readOnly} className="text-primary focus:ring-primary" />
            ...
            <label htmlFor="vendor-type-individual" className="flex items-center gap-2">
              <input id="vendor-type-individual" type="radio" value="Individual" {...register('vendorType')} disabled={readOnly} className="text-primary focus:ring-primary" />
