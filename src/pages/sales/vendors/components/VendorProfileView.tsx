                ...
                <div className="flex items-center gap-4">
                    ...
                    <div className="space-y-1">
                        ...
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded text-xs font-medium border ${vendor.status === 'Active'
                                ...
                                <div className="space-y-4">
                                    ...
                                    {vendor.alternatePhone && (
                                        <div>
                                            ...
                                            <span className="text-sm text-gray-800 dark:text-gray-300 flex items-center gap-1.5">
                                                <Phone size={14} className="text-gray-400" />
                                                <span>{vendor.alternatePhone}</span>
                                            </span>
                                        </div>
                                    )}
                                    {vendor.additionalContacts && vendor.additionalContacts.length > 0 && (
                                        <div className="pt-3 mt-3 border-t border-gray-100 dark:border-gray-800 space-y-4">
                                            {vendor.additionalContacts.map((contact, i) => (
                                            ...
                                            <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-gray-800/50 p-3 rounded-md border border-gray-100 dark:border-gray-800">
                                                ...
                                                <div>
                                                    ...
                                                    {vendor.shippingPhone && (
                                                        <div className="mt-2 pt-2 border-t border-gray-200 dark:border-gray-700 flex items-center gap-1.5 text-gray-800 dark:text-gray-300">
                                                            <Phone size={12} className="text-gray-400" />
                                                            <span>{vendor.shippingPhone}</span>
                                                        </div>
                                                    )}
                                                </div>
                                            </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-lg p-5 shadow-sm">
                                    ...
                                    <div className="space-y-5 mt-2">
                                        <div className="flex justify-between items-start gap-4">
                                            <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">GST Treatment</span>
                                            <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">
                                        ...
                                        {vendor.gstin && (
                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">GSTIN</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right break-all">{vendor.gstin}</span>
                                            </div>
                                        )}
                                        {vendor.panNumber && (
                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">PAN Number</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right break-all">{vendor.panNumber}</span>
                                            </div>
                                        )}
                                        {vendor.placeOfSupply && (
                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Place of Supply</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">{vendor.placeOfSupply}</span>
                                            </div>
                                        )}
                                    </div>
                                </div>
                                ...
                                {(vendor.paymentTerms || vendor.creditLimit || vendor.tdsPercentage || vendor.reverseCharge) ? (
                                    <div className="bg-white dark:bg-[#1a1a1a] border border-gray-200 dark:border-gray-800 rounded-lg p-5 shadow-sm">
                                        ...
                                        <div className="space-y-5 mt-2">
                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Payment Terms</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">{vendor.paymentTerms || 'Due on Receipt'}</span>
                                            </div>

                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Credit Limit</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">
                                            ...
                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">TDS Percentage</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">{vendor.tdsPercentage ? `${vendor.tdsPercentage}%` : '0%'}</span>
                                            </div>

                                            <div className="flex justify-between items-start gap-4">
                                                <span className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">Reverse Charge</span>
                                                <span className="text-sm text-gray-900 dark:text-gray-200 font-medium text-right">
                                    ...
                                    <div key={idx} className="flex gap-4 p-4 rounded-lg bg-gray-50 dark:bg-[#121212] border border-gray-100 dark:border-gray-800 text-sm">
                                        ...
                                        <div className="space-y-1.5 flex-1">
                                            <div className="flex justify-between items-center">
                                                <span className="font-semibold text-gray-900 dark:text-gray-100">{user?.username || 'System Admin'}</span>
