...
export default function SalesDashboard() {
  ...
  const pipelineStages = [
    ...
    { label: 'Confirmed Lead', statusMatches: ['Accepted', 'Confirmed Lead', 'Converted'], icon: Trophy },
  ].map(stage => {
      ...
      <div className="bg-white dark:bg-[#181a1f] p-6 rounded-sm border border-gray-200 dark:border-white/5 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            />
            <CustomSelect
              value={pipelineYear.toString()}
              onChange={(val) => setPipelineYear(Number(val))}
