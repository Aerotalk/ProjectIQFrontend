                ...
                <div className="grid grid-cols-[1fr_2fr] gap-y-5 text-sm">
                  ...
                  {client.gstin && (
                    <>
                      ...
                      <div className="text-gray-900 dark:text-gray-100 font-medium tracking-wide">{client.gstin}</div>
                    </>
                  )}
                  {client.panNumber && (
                    <>
                      <div className="text-gray-500 dark:text-gray-400">PAN Number</div>
                      <div className="text-gray-900 dark:text-gray-100 font-medium tracking-wide">{client.panNumber}</div>
                    </>
                  )}
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600 dark:text-gray-400 bg-gray-50 dark:bg-white/[0.02] p-4 rounded-sm border border-gray-200 dark:border-white/10">
                      ...
                      {client.billingPhone && <div className="mt-3 pt-3 border-t border-gray-200 dark:border-white/10 flex items-center gap-2"><Phone size={14} className="text-gray-400"/> {client.billingPhone}</div>}
                    </div>
                  </div>
