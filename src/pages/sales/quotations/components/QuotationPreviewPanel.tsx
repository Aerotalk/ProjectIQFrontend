...
export default function QuotationPreviewPanel({ isOpen, onClose, templateContent, data, filename = 'Quotation.pdf', title = 'Document Preview' }: QuotationPreviewPanelProps) {
