    ...
    <div className="flex flex-col gap-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button onClick={() => navigate('/companydashboard/payroll/list')} className="flex items-center gap-2 px-4 py-2 bg-[#792359] text-white rounded-sm hover:bg-[#5d1944] transition-colors text-sm font-medium shadow-sm">
            <Plus size={16} />
            New Payroll Run
          </button>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {stats.map((stat, i) => (
          <div key={i} className="bg-white dark:bg-[#181a1f] p-5 rounded-sm border border-gray-200 dark:border-white/10 shadow-sm flex items-center gap-4">
      ...
      <div className="bg-white dark:bg-[#181a1f] rounded-sm border border-gray-200 dark:border-white/10 shadow-sm">
        ...
        <div className="p-6 grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-4">
          {[
            ...
            <button key={i} onClick={() => navigate('/companydashboard/payroll/list')} className="flex flex-col items-center justify-center gap-3 p-4 rounded-sm border border-gray-100 dark:border-white/5 hover:border-[#792359]/30 hover:bg-[#792359]/5 transition-all group">
      ...
      <div className="bg-white dark:bg-[#181a1f] rounded-sm border border-gray-200 dark:border-white/10 shadow-sm">
        <div className="px-6 py-4 border-b border-gray-200 dark:border-white/10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="pl-9 pr-4 py-2 w-64 text-sm bg-gray-50 dark:bg-[#1f2229] border border-gray-200 dark:border-white/10 rounded-sm focus:outline-none focus:ring-1 focus:ring-[#792359]"
              />
            </div>
            <button className="flex items-center gap-2 px-3 py-2 border border-gray-200 dark:border-white/10 rounded-sm text-gray-600 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-white/5 transition-colors">
              <Filter size={16} />
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-sm text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-700 dark:text-gray-300 uppercase bg-gray-50 dark:bg-white/5">
              <tr>
                <th className="px-6 py-3 font-medium">Payroll Period</th>
                <th className="px-6 py-3 font-medium">Run Type</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-white/5">
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5">
                <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">June 2026</td>
                <td className="px-6 py-4">Regular</td>
                <td className="px-6 py-4">150</td>
                <td className="px-6 py-4">₹14,50,000</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-green-100 text-green-700 dark:bg-green-500/20 dark:text-green-400">Processed</span>
                </td>
                <td className="px-6 py-4 text-right">
                  <button onClick={() => navigate('/companydashboard/payroll/list')} className="text-[#792359] dark:text-[#e6a8d0] hover:underline font-medium">View</button>
                </td>
              </tr>
              <tr className="hover:bg-gray-50 dark:hover:bg-white/5">
                <td className="px-6 py-4 font-medium text-gray-900 dark:text-white">July 2026</td>
                <td className="px-6 py-4">Regular</td>
                <td className="px-6 py-4">142</td>
                <td className="px-6 py-4">₹13,80,000</td>
                <td className="px-6 py-4">
                  <span className="px-2.5 py-1 text-xs font-medium rounded-full bg-orange-100 text-orange-700 dark:bg-orange-500/20 dark:text-orange-400">Processing</span>
                </td>
                <td className="px-6 py-4 text-right">
                  <button onClick={() => navigate('/companydashboard/payroll/list')} className="text-[#792359] dark:text-[#e6a8d0] hover:underline font-medium">View</button>
                </td>
