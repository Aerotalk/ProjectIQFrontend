    ...
    <div className="max-w-[1400px] mx-auto space-y-6 pb-12">
        ...
        <div className="flex items-center gap-3">
          ...
          {formData.status === 'Closed' ? (
            <button 
              ...
              className="px-4 py-2 bg-primary text-white rounded-sm text-sm font-medium hover:bg-primary-dark flex items-center gap-2 transition-colors"
            >
            ...
            <>
              ...
              <button 
                onClick={() => onSave(formData)}
                className="px-4 py-2 bg-primary text-white rounded-sm text-sm font-medium hover:bg-primary-dark flex items-center gap-2 shadow-sm transition-colors"
              >
                <Save size={14} /> Save
              </button>
            </>
            ...
            return (
              <div 
                ...
                className={`flex-1 flex items-center justify-center text-sm font-medium cursor-pointer transition-all duration-300 relative z-10 select-none
                  ${isActive ? 'bg-primary text-white shadow-inner scale-105 z-20' : 
      ...
      <div className="bg-white dark:bg-[#181a1f] p-6 rounded-xl shadow-sm border border-gray-100 dark:border-white/5">
        <h2 className="text-sm font-bold text-gray-700 dark:text-gray-300 bg-gray-50 dark:bg-white/5 py-3 px-4 rounded-sm mb-6 flex items-center gap-2 border border-gray-200 dark:border-white/10">
          <FileText size={16} className="text-primary dark:text-secondary" /> General Summary - descriptions, priorities and assignments
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
          ...
          <div className="space-y-5 text-sm">
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Impact</label>
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Urgency</label>
              <div className="flex-1">
                <CustomSelect
                  value={urgency}
                  onChange={setUrgency}
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Requester</label>
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Method of Awareness</label>
              <div className="flex-1">
                <CustomSelect
                  value={method}
                  onChange={setMethod}
          ...
          <div className="space-y-5 text-sm">
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Assignment group</label>
              <div className="flex-1 flex gap-2">
                <div className="flex-1">
                  <CustomSelect
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* Assigned to</label>
              <div className="flex-1 flex gap-2">
                <div className="flex-1">
                  <CustomSelect
            ...
            <div className="flex items-center gap-4">
              <label className="w-40 text-right text-primary dark:text-secondary font-medium shrink-0">* GTOC Engaged?</label>
              <div className="flex-1">
                <CustomSelect
                  value={gtoc}
                  onChange={setGtoc}
        ...
        <div className="mt-8 space-y-5 text-sm">
          <div className="flex items-start gap-4">
            <label className="w-40 text-right text-primary dark:text-secondary font-medium pt-2 shrink-0">* Short description</label>
            <input type="text" value={formData.subject} onChange={(e) => setFormData({...formData, subject: e.target.value})} className="flex-1 px-3 py-2 bg-white dark:bg-[#1f2229] border border-gray-300 dark:border-white/20 rounded-sm text-gray-900 dark:text-white focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" />
          </div>
          <div className="flex items-start gap-4">
            <label className="w-40 text-right text-gray-600 dark:text-gray-400 font-medium pt-2 shrink-0">Detailed description</label>
            <textarea rows={6} className="flex-1 px-3 py-2 bg-white dark:bg-[#1f2229] border border-gray-300 dark:border-white/20 rounded-sm text-gray-900 dark:text-white focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" defaultValue="Ciroos Investigation: 1 alert correlated to this investigation. Failure rate increase | CLOSED"></textarea>
          </div>
        </div>
      </div>
    </div>
