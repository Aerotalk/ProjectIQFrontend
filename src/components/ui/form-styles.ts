...
export const formStyles = {
  ...
  sectionTitle: "text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider border-b border-b-gray-200 dark:border-b-white/10 pb-2 border-l-4 border-l-[#792359] pl-3 mb-4 flex items-center",
